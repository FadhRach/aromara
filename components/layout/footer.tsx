...
export default function Footer() {
  return (
    <footer className="bg-[#252F24] text-white py-12 md:py-16 px-4 md:px-6">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 mb-12">
          ...
          <div className="sm:col-span-2">
            <div className="flex items-center gap-3 mb-6">
              ...
              />
              <div>
                <div className="font-bold text-white text-xl">Aromara</div>
                <div className="text-sm text-[#E8F5D5]/80">Local Sourcing Global Fragrance</div>
              </div>
            </div>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-6">
            <Link 
              href="mailto:hello@aromara.id" 
              className="text-sm text-white/80 hover:text-[#E8F5D5] transition"
            >
              hello@aromara.id
            </Link>
            ...
            <div className="flex gap-4">
              <Link 
                href="https://instagram.com/aromara" 
                target="_blank"
                className="text-white/70 hover:text-[#E8F5D5] transition" 
              ...
              <Link 
                href="https://twitter.com/aromara" 
                target="_blank"
                className="text-white/70 hover:text-[#E8F5D5] transition" 
                aria-label="Twitter"
              >
              ...
              <Link 
                href="https://linkedin.com/company/aromara" 
                target="_blank"
                className="text-white/70 hover:text-[#E8F5D5] transition" 
                aria-label="LinkedIn"
              >
